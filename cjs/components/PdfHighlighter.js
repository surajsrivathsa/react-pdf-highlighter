...
class PdfHighlighter extends react_1.PureComponent {
    constructor(props) {
        ...
        this.afterSelection = () => {
            ...
            const pages = (0, pdfjs_dom_1.getPagesFromRange)(range); //pdfjs method that returns elements for paginated page pdf ranges
            ...
            let boundingRect = (0, get_bounding_rect_1.default)(rects);
    ...
    viewportPositionToScaled({ pageNumber, boundingRect, rects, }) {
        ...
        const viewport = this.viewer.getPageView(paginatedPageNumber - 1).viewport;
        console.log("viewportPositionToScaled: ", (0, coordinates_1.viewportToScaled)(boundingRect, viewport), " pageNumber: ", pageNumber);
        ...
        return {
            ...
            rects: (updatedRectObjects || []).map((rect) => (0, coordinates_1.viewportToScaled)(rect, viewport)),
            pageNumber,
        };
    }
